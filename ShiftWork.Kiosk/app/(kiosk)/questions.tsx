...
const styles = StyleSheet.create({
  ...
  yesNoBtnSelected: { borderColor: colors.primary, backgroundColor: colors.primaryLight },
  yesNoText: { ...typography.title, color: colors.textSecondary },
  yesNoTextSelected: { color: colors.primary, fontWeight: '700' as const },
  ...
  choiceRowSelected: { borderColor: colors.primary, backgroundColor: colors.primaryLight },
  choiceText: { ...typography.body, color: colors.textSecondary },
  choiceTextSelected: { color: colors.primary, fontWeight: '600' as const },
  textInput: {
    backgroundColor: colors.surfaceElevated,
    borderRadius: radius.lg,
    borderWidth: 1,
  ...
  submitText: { ...typography.title, color: '#fff', letterSpacing: -0.2 },
